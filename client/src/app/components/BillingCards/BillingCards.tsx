  ...
  const billingCardsData = [
    {
      ...
      desc: "Lorem Ipsum is simply dummy text of the printing and typeset ting industry lorem Ipsum",
    },
    {
      imageUrl:
  ...
  return (
    <div className="w-full h-[238px] flex justify-center py-[30px] gap-4  ">
      {billingCardsData.map((card, index) => (
        <div
          key={index}
          className="flex w-[299px] h-[178px] flex-col items-center p-4 pt-8 bg-white border border-[#e4e6e6]"
        >
